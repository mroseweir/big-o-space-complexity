...
// ANSWER: Yes here is a O(n) function

// let numbers = [76,35,73,13,4,88,23,12,86,1,54,9,10,2] 

function numbersSquared(numbers) {
  let numbers2 = []
  for (let i in numbers) {
    let square = numbers[i] * numbers[i]
    numbers2.push(square)
  }
  console.log(numbers2)
};

numbersSquared(numbers)
...
// ANSWER: The space complexity of both functions is dependent on the length of the string that is being passed in.
...
const mySqr = new Sqrt()

console.time("not memoized function time");
console.log(squareRt(4))
console.log(squareRt(4))
console.log(squareRt(4))
console.log(squareRt(4))
